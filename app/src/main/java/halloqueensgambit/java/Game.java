...
public class Game {
    ...
    public long generateZobristHash() {
        ...
        // for now they are left out. this will cause bugs in certain positions
        // involving castling/en passant.
        long hash = 0;
        int sideIsBlack = 768;
    ...
    // Return a list of position a non-king piece must take in order to break the
    // check
    // A valid position might be a blocking or taking of the checking enemy piece
    // It will return EMPTY if there is a DOUBLE CHECK thus you can not break the
    // check only move king
